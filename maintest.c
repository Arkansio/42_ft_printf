...
/*   Updated: 2019/01/24 04:32:17 by mgessa           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//
	...
	char		t84[] = "t84: Pointer: %0 10.2d %0 15.2x %0 15.2X %0 15.2u %0 15.2o\n";
	nb1 = printf(t84, 50, 50, 50, 50, 50);
	nb2 = ft_printf(t84, 50, 50, 50, 50, 50);
	print_result(nb1, nb2);

	char		t85[] = "t85: Double: %f %f %f %f\n";
	nb1 = printf(t85, 50.2555567, 50.123456489, 50.5999999, 50.555555555);
	nb2 = ft_printf(t85, 50.2555567, 50.123456489, 50.5999999, 50.555555555);
	print_result(nb1, nb2);

	char		t86[] = "%.2f %10.2f %0 15.2f %0 15.2f %0 15.2f %0 15.2f\n";
	nb1 = printf(t86, 50.00, 50.0, 50.0, 50.0, 50.0, 50.0);
	nb2 = ft_printf(t86, 50.00, 50.0, 50.0, 50.0, 50.0, 50.0);
	print_result(nb1, nb2);

	char		t87[] = "[t87] Zero test: %f\n";
	nb1 = printf(t87, 0.0);
	nb2 = ft_printf(t87, 0.0);
	print_result(nb1, nb2);

	char		t88[] = "[t88] Zero test: %.f %.2f\n";
	nb1 = printf(t88, 0.0, 0.01);
	nb2 = ft_printf(t88, 0.0, 0.01);
	print_result(nb1, nb2);

	char		t89[] = "[t88] Print test: %.f %.2f\n";
	nb1 = printf(t89, 0.1234, 0.1234);
	nb2 = ft_printf(t89, 0.1234, 0.1234);
	print_result(nb1, nb2);

	char		t90[] = "[t90] Print test: %.f %.2f\n";
	nb1 = printf(t90, -0.1234, -0.1234);
	nb2 = ft_printf(t90, -0.1234, -0.1234);
	print_result(nb1, nb2);

	char		t91[] = "[t91] Print test: %.f %.2f\n";
	nb1 = printf(t91, -42.1234, -42.1234);
	...
	char		t95[] = "[t95] Print test: %.8f %.10f %.18f %.19f %.80f\n";
	nb1 = printf(t95, 42.1255555555, -42.125555555555555, 452.125555555555555, 452.125555555555555, 452.125555555555555);
	nb2 = ft_printf(t95, 42.1255555555, -42.125555555555555, 452.125555555555555, 452.125555555555555, 452.125555555555555);
	print_result(nb1, nb2);

	char		t96[] = "[t96] Print test: %.2f %.18f\n";
	...
	char		t98[] = "[t98] Print test: %.2 f %.6f\n";
	nb1 = printf(t98, 0.000, -0.0);
	nb2 = ft_printf(t98, 0.000, -0.0);
	print_result(nb1, nb2);

	char		t99[] = "[t99] Print test: % x f %+ f\n";
	nb1 = printf(t99, 0, 0.5);
	nb2 = ft_printf(t99, 0, 0.5);
	print_result(nb1, nb2);

	char		t100[] = "[t100] Print test: % x f %.1+010f\n";
	nb1 = printf(t100, 10, -0.5);
	nb2 = ft_printf(t100, 10, -0.5);
	print_result(nb1, nb2);

	char		t101[] = "[t101] Print test: %#x f %.1+010f\n";
	nb1 = printf(t101, 10, -0.0505);
	nb2 = ft_printf(t101, 10, -0.0505);
	print_result(nb1, nb2);


	char		t102[] = "[t102] Print test: %#.f\n";
	nb1 = printf(t102, 0.0);
	nb2 = ft_printf(t102, 0.0);
	print_result(nb1, nb2);

	char		t103[] = "[t103] Print test: %#.d %.1 010d\n";
	nb1 = printf(t103, -0, -0);
	nb2 = ft_printf(t103, -0, -0);
	print_result(nb1, nb2);

	char		t104[] = "[t104] Print test: %#.f %.1 010f\n";
	nb1 = printf(t104, -0.05, 0.0123);
	nb2 = ft_printf(t104, -0.05, 0.0123);
	print_result(nb1, nb2);

	char		t105[] = "[105] {%#.5x} %#.2x %#08x\n";
	nb1 = printf(t105, 1, 1, 42);
	nb2 = ft_printf(t105, 1, 1, 42);
	print_result(nb1, nb2);

	char		t106[] = "[t106] {%#.5x} %#.2x %#08x %-10#x\n";
	nb1 = printf(t106, 0, 0, 0, 0);
	nb2 = ft_printf(t106, 0, 0, 0, 0);
	print_result(nb1, nb2);

	char		t107[] = "[t107] {%#.5x} %#.2x %#.40x %-10.8#x\n";
	nb1 = printf(t107, 1, 1, 1, 1);
	nb2 = ft_printf(t107, 1, 1, 1, 1);
	print_result(nb1, nb2);
}