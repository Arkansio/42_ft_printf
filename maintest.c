...
/*   Updated: 2019/01/13 02:59:32 by mgessa           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//
	...
	char		t95[] = "[t94] Print test: %.8f %.10f %.18f %.19f %.80f\n";
	...
	char		t96[] = "[t93] Print test: %.2f %.20f\n";
	nb1 = printf(t96, 42.1249, -42.1);
	nb2 = ft_printf(t96, 42.1249, -42.1);
	print_result(nb1, nb2);
